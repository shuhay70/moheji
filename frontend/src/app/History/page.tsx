...
const HistoryPage = () => {
  return (
    <main
      className="lg:py-[100px] py-[65px]" // ヘッダーの高さに応じたパディングと全高に設定
      style={{
    ...
    >
      <p className="bg-white lg:ml-[150px] lg:mr-[138px] lg:p-[30px] w-[80vw] h-[30px] w-[312px] h-[30px] ml-[38px]"></p>
      <SimpleBar
        className="lg:ml-[150px] ml-[38px]"
        style={{
          maxHeight: "80vh",
          width: "80vw",
          overflowY: "auto",
      ...
      >
        ...
        <div className="lg:w-[1100px] border-t border-gray-300 lg:my-[40px] w-[270px]  my-[25px]"></div>
        <div className="lg:flex">
          <div>
            <div className="lg:flex">
